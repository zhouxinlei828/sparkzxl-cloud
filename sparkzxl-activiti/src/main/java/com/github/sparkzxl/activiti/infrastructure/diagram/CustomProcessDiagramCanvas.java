package com.github.sparkzxl.activiti.infrastructure.diagram;
...
public class CustomProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
    ...
    public BufferedImage generateBufferedImage(String imageType) {
        ...
        minX = Math.max(minX, WorkflowConstants.PROCESS_PADDING);
        minY = Math.max(minY, WorkflowConstants.PROCESS_PADDING);
